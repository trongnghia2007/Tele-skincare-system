document.addEventListener("DOMContentLoaded", function() {
 ...
 // ======================================================================================================= //
          ...
          description.textContent = image.filename.split('_')[1];
          ...
          const accuracy = image.filename.split('_')[2].split('.')[0]; 
          acc.textContent = `Chính xác: ${accuracy}%`;
          frameDiv.appendChild(acc);
